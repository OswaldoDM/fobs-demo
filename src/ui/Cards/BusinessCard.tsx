...
function BusinessCard({ cardBg, section, business }: Props) {

  const { businessName, pic, stars, location, typeLocation, status, type, rating, reviews, review, tags } = business;
      ...
      <div className="flex flex-col justify-between gap-3 py-3 px-2 2xl:min-h-[50%] 2xl:py-4">
        ...
        <div className='flex items-center gap-2'>          
          <svg aria-hidden="true" width="12" height="17" viewBox="0 0 12 17" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M5.83333 0C2.60833 0 0 2.60833 0 5.83333C0 7.28333 0.416667 8.64167 1.175 9.86667C1.96667 11.15 3.00833 12.25 3.80833 13.5333C4.2 14.1583 4.48333 14.7417 4.78333 15.4167C5 15.875 5.175 16.6667 5.83333 16.6667C6.49167 16.6667 6.66667 15.875 6.875 15.4167C7.18333 14.7417 7.45833 14.1583 7.85 13.5333C8.65 12.2583 9.69167 11.1583 10.4833 9.86667C11.25 8.64167 11.6667 7.28333 11.6667 5.83333C11.6667 2.60833 9.05833 0 5.83333 0ZM5.83333 8.125C4.68333 8.125 3.75 7.19167 3.75 6.04167C3.75 4.89167 4.68333 3.95833 5.83333 3.95833C6.98333 3.95833 7.91667 4.89167 7.91667 6.04167C7.91667 7.19167 6.98333 8.125 5.83333 8.125Z" fill="#F1090D"/>
          </svg>
          <p>
            {location} · $ · {status}
          </p>
        ...
        {/* TYPE OF BUSINESS */}
        <div className='flex items-center gap-2'>       
          <svg aria-hidden="true" width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* REVIEW */}
        <div className='flex items-center gap-2'>          
          <svg aria-hidden="true" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 mb-2">
