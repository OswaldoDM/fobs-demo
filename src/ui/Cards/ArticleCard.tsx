    ...
    >
      ...
      <div className='flex justify-between items-center p-2'>
        <div className='flex gap-3'>
          ...
          <div>
            ...
            <img src={stars} alt='article reviews' loading='lazy' />
          </div>
        </div>
      ...
      <div className='flex justify-between items-baseline p-2'>
        ...
        <svg aria-hidden="true" width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path stroke="#F5F5F5" strokeWidth="1.4" strokeLinejoin="round" d="M8.19995 9.7002L0.699951 6.7002L17.2 0.700195L11.2 17.2002L8.19995 9.7002ZM8.19995 9.7002L11.95 5.9502"/>
        </svg>        
      </div>
      ...
      <div className='flex flex-col justify-between gap-2 py-3 px-2 min-h-[30%] md:min-h-[33%]'>
        <div className='flex gap-2'>
          <div className='flex'>
            <img src={like3} alt='likes' className='w-4 h-4 rounded-full' loading="lazy" />
            <img
              src={like2}
              alt='likes'
