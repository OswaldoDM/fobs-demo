...
//   return (    
//     <div className="container mx-auto flex flex-col gap-8 px-4 md:flex-row md:gap-4 xl:px-0">
...
//           {/* Business Card */}
//           <div className='text-xs rounded-lg bg-[#F5F5F5] border border-[#C4C4C4]'>

//             <div className='mb-4 relative'>
//               <img src={Ellies} alt="Ellies" className='w-full' />
//               <div className='bg-[#181818] rounded py-1 px-2 text-white absolute top-1 left-1'>Main Street</div>
//             </div>

//             <div className='mb-1 px-2 flex justify-between'>
//               <p className="font-bold text-base">Ellie’s Pie Barn</p>
//               <img src={halfStars} alt="stars" />              
//             </div>
            
//             <p className=' text-right mb-4 pr-2'>4.9 (642 reviews)</p>            

//             <div className='mb-4 px-2 flex items-center gap-2'>
//               <img src={location} alt="location" className='w-[14px]' />
//               <p>Chicago, IL· $$ · Closed until 8:00 AM</p>
//             </div>
...
//             <div className='mb-4 px-2 flex items-center gap-2'>
//               <img src={review} alt="type of business" className='w-[14px]' />
//               <p>‘’The peach pie here tastes exactly like the 
//                 one my grandma used to bake. Crispy crust,...’’
//               </p>
//             </div>

//             <div className='flex gap-2 mb-4 px-2'>
//               <div className='border border-black rounded-lg py-1 px-2'>Bakery</div>
//               <div className='border border-black rounded-lg py-1 px-2'>Desert</div>
//               <div className='border border-black rounded-lg py-1 px-2'>Pies</div>
//             </div>
          ...
          {businessData.map((business, index) => (
            <div key={index} className='text-xs rounded-lg bg-[#F5F5F5] border border-[#C4C4C4]'>
              ...
              <div className='mb-1 px-2 flex justify-between items-center'>
                ...
                <img src={business.stars} alt="stars" className='w-16 h-4' /> {/* Ajusta el tamaño si es necesario */}
              </div>
