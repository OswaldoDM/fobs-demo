...
function Landing() {
  return (
    ...
    <div className="flex flex-col items-center justify-center gap-4 lg:gap-8 py-44 lg:py-56 text-center px-3 lg:px-0">
      ...
      <div className='mt-4 w-[320px] sm:w-[500px] md:w-[600px] lg:w-[800px] xl:w-[900px] 2xl:w-[1000px]'>
        <div
          className='w-full rounded-[40px] py-4 px-5 lg:py-5 flex items-center border border-secondary_gray 
